...
const Skill = () => {
    ...
    return (
        <div className="w-[50%]">
            <h1 className="text-white font-bold mb-4 text-[1.5rem] font-poppins">Skills</h1>
            <div className="flex justify-between gap-4">
                <div className="px-4 py-12 shadow-sm shadow-primary-0 rounded-xl w-[50%]">
                    <h1 className="text-[1.2rem] font-semibold font-poppins text-primary-0 mb-4">Frontend Developer</h1>
                ...
                <div className="px-4 py-12 shadow-sm shadow-primary-0 rounded-xl w-[50%]">
                    <h1 className="text-[1.2rem] font-semibold font-poppins text-white mb-4">Creative Designer</h1>
